...
void inicializarPeca(tipo_peca dominoAux[], tipo_jogo domino[], tipo_mesa tabuleiro[])
{
    int i;
    int valorp1 = 0;
    int valorp2 = 0;
...
void definirMaior(tipo_jogo domino[], tipo_peca jogador1[], tipo_peca jogador2[], tipo_peca monte[]){
    ...
    if(mDobra1 != -1 && mDobra2 != -1){
        ...
        if(mDobra1 > mDobra2){
            domino[0].j_maiorP1 = mDobra1;
            domino[0].j_maiorP2 = mDobra1;
            domino[0].jogaPrimeiro = 1;

        // ja neste caso, o jogador 2 será o primeiro a jogar    
        } else if( mDobra2 > mDobra1){
            domino[0].j_maiorP1 = mDobra2;
            domino[0].j_maiorP2 = mDobra2;
            domino[0].jogaPrimeiro = 2;
        }
    ...
    //jogador 1 e 2 apenas estão com peças normais
        ...
        if(aux1_p1 > aux2_p1){
            domino[0].j_maiorP1 = aux1_p1;
            domino[0].j_maiorP2 = aux1_p2;
            domino[0].jogaPrimeiro = 1;

        }else if(aux2_p1 > aux1_p1){
            domino[0].j_maiorP1 = aux2_p1;
            domino[0].j_maiorP2 = aux2_p2;
            domino[0].jogaPrimeiro = 2;
        }
    }
...
// Escolhe a direção da jogada
char escolherDirecao(){

    char escolha [10];

    printf("\nEm que direcao voce gostaria de fazer sua jogada ?");
    printf("\n Escolha: ");
    scanf("%s", escolha);
    flush_in();
...
int  acharMaior(tipo_jogo domino[], tipo_peca jogador1[], tipo_peca jogador2[] ){
    ...
    if(domino[0].rodadaVez % 2 != 0){
        for(i=0; i<7; i++){    
            ...
            if(jogador1[i].p1 == domino[0].j_maiorP1 && jogador1[i].p2 == domino[0].j_maiorP2){
    ...
    if(domino[0].rodadaVez % 2 == 0){
        for(i=0; i<7; i++){    
            if(jogador2[i].p1 == domino[0].j_maiorP1 && jogador2[i].p2 == domino[0].j_maiorP2){
                return i;
...
void verificarJog1(tipo_jogo domino[], tipo_peca jogador1[], tipo_mesa tabuleiro[], char escolha, int peca){
    ...
    if(escolha == 'E'){
        ...
        if(jogador1[peca].p1 == tabuleiro[0].mapa[posicaoI - tabuleiro[0].ext_esq + 2]){
        ...
        //========================================================|
            ...
            tabuleiro[0].mapa[posicaoI - tabuleiro[0].ext_esq] = troca_p1;
            tabuleiro[0].mapa[posicaoF - tabuleiro[0].ext_esq] = troca_p2;
            tabuleiro[0].ext_esq = tabuleiro[0].ext_esq + 2;

            domino[0].jogou = 1;

        } else if(jogador1[peca].p2 == tabuleiro[0].mapa[posicaoI - tabuleiro[0].ext_esq + 2]){
    ...
    if (escolha == 'D'){
        ...
        if(jogador1[peca].p1 == tabuleiro[0].mapa[posicaoF + tabuleiro[0].ext_dir - 2]){
            ...
            jogador1[peca].p1 = -1;
            jogador1[peca].p2 = -1;
            tabuleiro[0].mapa[posicaoI + tabuleiro[0].ext_dir] = troca_p1;
            tabuleiro[0].mapa[posicaoF + tabuleiro[0].ext_dir] = troca_p2; 
            tabuleiro[0].ext_dir = tabuleiro[0].ext_dir + 2;

            domino[0].jogou = 1;

        }else if(jogador1[peca].p2 == tabuleiro[0].mapa[posicaoF + tabuleiro[0].ext_dir - 2]){
            //======================================================|
                /*INVERTE A ATRIBUICAO  
                  -Exemplo: 4|4  1|4
                           (mP1|mP2 p1|p2)
...
void verificarJog2(tipo_jogo domino[], tipo_peca jogador2[], tipo_mesa tabuleiro[], char escolha, int peca){
    ...
    if(escolha == 'E'){
        ...
        if(jogador2[peca].p1 == tabuleiro[0].mapa[posicaoI - tabuleiro[0].ext_esq + 2]){
        ...
        } else if(jogador2[peca].p2 == tabuleiro[0].mapa[posicaoI - tabuleiro[0].ext_esq + 2]){
    ...
    if (escolha == 'D'){
        ...
        if(jogador2[peca].p1 == tabuleiro[0].mapa[posicaoF + tabuleiro[0].ext_dir - 2]){
    ...
    }else if(jogador2[peca].p2 == tabuleiro[0].mapa[posicaoF + tabuleiro[0].ext_dir - 2]){
        //======================================================|
            /*INVERTE A ATRIBUICAO  
              -Exemplo: 4|4  1|4
                       (mP1|mP2 p1|p2)
...
void comprarPeca(tipo_jogo domino[], tipo_peca jogador1[], tipo_peca jogador2[], tipo_peca monte[], tipo_mesa tabuleiro[], int *k, int *cont_1, int *cont_2){
    ...
    if(i > 0 && verjog == 0){
        ...
        while(achou == false && *k < 14){
            ...
            //no Lado esquerdo 
                if(monte[*k].p1 == tabuleiro[0].mapa[posicaoI - tabuleiro[0].ext_esq + 2]){
                    aux_p1 = monte[*k].p1;
                    aux_p2 = monte[*k].p2;
                    ...
                    achou =true;
                }else if(monte[*k].p2 == tabuleiro[0].mapa[posicaoI - tabuleiro[0].ext_esq + 2]){
                    aux_p1 = monte[*k].p1;
                    aux_p2 = monte[*k].p2;
                    monte[*k].p1 = -1;
                    monte[*k].p2 = -1;
                    ...
                    achou =true;
                //no Lado direito
                }else if(monte[*k].p1 == tabuleiro[0].mapa[posicaoF + tabuleiro[0].ext_dir - 2]){
                    aux_p1 = monte[*k].p1;
                    aux_p2 = monte[*k].p2;
                    monte[*k].p1 = -1;
                    monte[*k].p2 = -1;
                    ...
                    achou =true;
                }else if(monte[*k].p2 == tabuleiro[0].mapa[posicaoF + tabuleiro[0].ext_dir - 2]){
                    aux_p1 = monte[*k].p1;
                    aux_p2 = monte[*k].p2;
                    monte[*k].p1 = -1;
                    monte[*k].p2 = -1;
...
int verificarCompra(tipo_jogo domino[], tipo_peca jogador1[], tipo_peca jogador2[], tipo_mesa tabuleiro[]){
    ...
    if(domino[0].rodadaVez %2 != 0){
        ...
        for(i = 0; i < 21; i++){
            ...
            if(jogador1[i].p1 == tabuleiro[0].mapa[posicaoI - tabuleiro[0].ext_esq + 2]){
                veri = 1;

            }else if(jogador1[i].p2 == tabuleiro[0].mapa[posicaoI - tabuleiro[0].ext_esq + 2]){
                veri = 1;

            }else if(jogador1[i].p1 ==  tabuleiro[0].mapa[posicaoF + tabuleiro[0].ext_dir - 2]){
                veri = 1;

            }else if(jogador1[i].p2 ==  tabuleiro[0].mapa[posicaoF + tabuleiro[0].ext_dir - 2]){
                veri = 1;
            }
        }   
    ...
    if(domino[0].rodadaVez %2 == 0){
        ...
        for(i = 0; i < 21; i++){
            ...
            if(jogador2[i].p1 == tabuleiro[0].mapa[posicaoI - tabuleiro[0].ext_esq + 2]){
                veri = 1;

            }else if(jogador2[i].p2 == tabuleiro[0].mapa[posicaoI - tabuleiro[0].ext_esq + 2]){
                veri = 1;

            }else if(jogador2[i].p1 ==  tabuleiro[0].mapa[posicaoF + tabuleiro[0].ext_dir - 2]){
                veri = 1;

            }else if(jogador2[i].p2 ==  tabuleiro[0].mapa[posicaoF + tabuleiro[0].ext_dir - 2]){
               veri = 1;
...
void contarPontos(tipo_jogo domino[], tipo_peca jogador1[], tipo_peca jogador2[]){
    ...
    for(i = 0; i < 21; i++){
        ...
        if(jogador1[i].p1 != -1 && jogador1[i].p2 != -1 && jogador1[i].status == 'U'){
            domino[0].pontosJ1 = domino[0].pontosJ1 + jogador1[i].p2 + jogador1[i].p1;
        }
        
        if(jogador2[i].p1 != -1 && jogador2[i].p2 != -1 && jogador2[i].status == 'U'){
            domino[0].pontosJ2 = domino[0].pontosJ2 + jogador2[i].p2 + jogador2[i].p1;
        }
    }
}
...
void inicializaMesa(tipo_mesa tabuleiro[]){
    ...
    //SETUP DA MESA
    for(i = 0; i < 100; i++){
        tabuleiro[0].mapa[i] = -1;
    }

    tabuleiro[0].h_esq = 42;
    tabuleiro[0].h_dir = 77;
}
    ...
    while(achou == false && i < 21){
       ...
       if((monte[j].p1 != -1 && monte[j].p2 != -1) || (monte[j].status == 'C')){
        ...
        if(cont  == 0){
             ...
             printf("\n\t BOT NAO POSSUI NENHUMA PECA PARA COLOCAR NA MESA\n\t ->MONTE VAZIO!!");
